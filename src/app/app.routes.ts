...
import {
  PmProjectDetailsComponent
} from './pages/project-management-page/pm-project-details/pm-project-details.component';
...
export const routes: Routes = [
  ...
  },*/
  {
    ...
    children: [
      {
        path: 'lista',
        loadComponent: () => import('@pages/adm-cursos/adm-cursos-lista/adm-cursos-lista.component').then(c => c.AdmCursosListaComponent)
      },
